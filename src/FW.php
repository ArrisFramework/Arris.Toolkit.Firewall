...
class FW
{
     ...
     * @return $this
     */
    public function setDefaultState(bool $allowed = false):FW
    {
     ...
     * @return $this
     */
    public function addWhiteList($list):FW
    {
        if (is_array($list)) {
     ...
     * @return $this
     */
    public function addBlackList($list):FW
    {
        if (is_array($list)) {
     ...
     * @return $this
     */
    public function setHandler(callable $callback):FW
    {
     ...
     * @return $this
     */
    public function validate($ip = null):FW
    {
        if (is_null($ip)) {
            $ip = $this->getIP();
